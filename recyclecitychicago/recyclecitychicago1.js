...
function initialize() {
  ...
  downloadUrl("output.xml", function(data) {
		...
		var records = xmlDoc.getElementsByTagName("Pts");
		...
		for (var i = 0; i < records.length; i++) {
		  ...
		  */
		  var id = rec.getElementsByTagName("ID")[0].childNodes[0].nodeValue;
		  var name = rec.getElementsByTagName("NAME")[0].childNodes[0].nodeValue;
		  var type = rec.getElementsByTagName("TYPE")[0].childNodes[0].nodeValue;
		  var addr = rec.getElementsByTagName("Address")[0].childNodes[0].nodeValue;
		  //var addr = rec.getElementsByTagName("FullAddress")[0].childNodes[0].nodeValue;
		  var lat = rec.getElementsByTagName("Lat")[0].childNodes[0].nodeValue;
		  var lng = rec.getElementsByTagName("Lng")[0].childNodes[0].nodeValue;
		  if(rec.getElementsByTagName("Phone")[0].childNodes[0]) var phone = rec.getElementsByTagName("Phone")[0].childNodes[0].nodeValue;
		  else var phone = "";
		  var hrs = rec.getElementsByTagName("Hours")[0].childNodes[0].nodeValue;
		  var cbrd = rec.getElementsByTagName("Cardboard")[0].childNodes[0].nodeValue;
		  var gp = rec.getElementsByTagName("GlassPlastic")[0].childNodes[0].nodeValue;
		  var met = rec.getElementsByTagName("Metals")[0].childNodes[0].nodeValue;
		  //set google point
